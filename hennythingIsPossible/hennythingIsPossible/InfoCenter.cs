...
namespace hennythingIsPossible
{
    public class InfoCenter
    {
        ...
        public void Alcohol()
        {
            ...
            Types.Add(new InfoCenter("Tequla", "Tequila is a regional distilled beverage and type of alcoholic drink made from the blue agave plant, primarily in the area surrounding the city of Tequila, 65 km northwest of Guadalajara, and in the Jaliscan Highlands of the central western Mexican state of Jalisco"));
            ...
            while (run)
            {
                ...
                foreach (InfoCenter Type in Types)
                {
                ...
                if (userInput == 1)
                {
                    Console.WriteLine(" {0} is {1}. Hit enter to see an example", Types[userInput - 1].Name, Types[userInput - 1].Definition);
                    Console.ReadLine();
